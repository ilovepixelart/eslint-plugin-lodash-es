...
- 🎉 **Initial release**
- ✨ **Auto-fixable rule**: Converts lodash imports to destructured imports
- 🔧 **Smart detection**: Analyzes code to find used lodash functions
- 📦 **TypeScript support**: Full TypeScript definitions included
- 🧪 **Comprehensive tests**: Full test coverage with Vitest
- 📖 **Standard approach**: Follows TypeScript ESLint configuration patterns
- 🚀 **Modern tooling**: Built with pkgroll, supports ESM/CJS dual exports
